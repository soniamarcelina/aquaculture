            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="mr-2 d-none d-lg-inline text-gray-600 small">ANONYM</span>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="row row-col-auto ">
                          <div class="col-6 col-sm-6 font-weight-bold text-danger">Ruangan</div>
                          <div class="col-6 col-sm-6 font-weight-bold text-danger">Air Kolam</div>
                          <br>
                          <div class="col-6 col-sm-6 font-weight-bold text-gray-800">
                          <?php
                          foreach ($yourlimit as $key => $value) {
              ...
              <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xl font-weight-bold text-success text-uppercase text-center mb-3">Potential Hydrogen (PH)</div>
                        <hr>
                        <div class="h5 mb-0 font-weight-bold text-gray-800 text-center">
                        <?php
                          foreach ($yourlimit as $key => $value) {
              ...
              <div class="text-center">
                <img src="kolam.jpg" class="rounded" alt="desain">
              </div>
              <br>
